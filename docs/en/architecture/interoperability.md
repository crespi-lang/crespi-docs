...
The Crespi Foreign Function Interface (FFI) layer enables seamless communication between Crespi code and native host code (primarily Rust, with C-ABI compatibility).
